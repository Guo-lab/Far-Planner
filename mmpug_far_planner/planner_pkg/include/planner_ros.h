...
class PlannerNode {
    ...
    private:
         ...
         *  plannerReqHandler is the callback function, used to get the local planner's 
         ...
         *  plannerCurrPoseHandler is the callback function, used to get the current pose of the robot.
         */
        ...
        /**
         * @brief The GridPlanner class represents a planner for grid-based path planning. Defined in GRID_PLANNER_H.
         */
        GridPlanner planner;
